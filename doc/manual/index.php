...
interpretation is not required, this method need not be called.</p><p>The <a href="../api/org/fit/cssbox/css/DOMAnalyzer.html#addStyleSheet(java.net.URL, java.lang.String, org.fit.cssbox.css.DOMAnalyzer.Origin)" class="api">addStyleSheet()</a> 
...
the viewport dimension. Then, the layout is not computed automatically and it must be created by a subsequent
...
the rendered document and for obtaining the created layout model.</p></div><div class="subsection" id="basicDisplay"><h3>Configuration Options</h3><p>Current browser configuration is represented using a
...
example.</p></div></div><div xmlns="http://www.w3.org/1999/xhtml" xmlns:doc="http://cssbox.sourceforge.net/docs" class="section" id="model"><h2>Rendered Document Model</h2><p>The resulting document layout is represented as a tree of <dfn>boxes</dfn>. Each box
